    ...
    fProxyIpValid(true)
{
    ...
    ui->unit->setModel(new SiriuscoinUnits(this));
...
void OptionsDialog::setMapper()
{
    ...
    mapper->addMapping(ui->siriuscoinAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::showRestartWarning_Proxy()
{
    ...
    {
        QMessageBox::warning(this, tr("Warning"), tr("This setting will take effect after restarting Siriuscoin."), QMessageBox::Ok);
